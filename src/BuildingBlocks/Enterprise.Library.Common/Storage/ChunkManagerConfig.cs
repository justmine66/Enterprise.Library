...
namespace Enterprise.Library.Common.Storage
{
    public class ChunkManagerConfig
    {
                               ...
                               bool enableChunkStatistic)
        {
            ...
            this.ChunkDataUnitSize = chunkDataUnitSize;
            this.ChunkDataCount = chunkDataCount;
            this.FlushChunkIntervalMilliseconds = flushChunkIntervalMilliseconds;
            this.EnableCache = enableCache;
            this.SyncFlush = syncFlush;
            this.FlushOption = flushOption;
            this.ChunkReaderCount = chunkReaderCount;
            this.MaxLogRecordSize = maxLogRecordSize;
            this.ChunkWriteBuffer = chunkWriteBuffer;
            this.ChunkReadBuffer = chunkReadBuffer;
            this.ChunkCacheMaxCount = chunkCacheMaxCount;
            this.ChunkCacheMinCount = chunkCacheMinCount;
            this.PreCacheChunkCount = preCacheChunkCount;
            this.ChunkInactiveTimeMaxSeconds = chunkInactiveTimeMaxSeconds;
        ...
        public int GetChunkDataSize()
        {
            ...
            return this.ChunkDataUnitSize * this.ChunkDataCount;
        }
    }
}
