...
namespace InfrastructureTest
{
    public class Latch
    {
        ...
        private int m_state = 0; // 0 = unset, 1 = set.
        ...
        public bool Wait(int timeout)
        {
            ...
            while (this.m_state == 0)
            {
                ...
                else
                {
                    ...
                    // Do the wait.
                    if (realTimeout <= 0 && !m_ev.WaitOne(timeout))
                    {
    ...
    /// <summary>
    /// Use SpinWait to Implement a Two-Phase Wait Operation
    /// </summary>
    public class TwoPhraseWaitOfSpinWaitImplTest
    {
